...
class Bird extends Animal {
	...
	@Override
	void makeSound() {
		System.out.println(name+" Sound :  chirps");
	}
	// Bird Display Method
	void display() {
		super.display();
...
class Fish extends Animal {
	...
	@Override
	void makeSound() {
		System.out.println(name+" Sound :  makes no sound");
	}
...
public class AnimalsDetails {
	...
	public static void main(String[] args) {
		Animal d1 = new Dog("Olly", 3, "Home", "Golden Retriever", true, "woof woof");
		d1.display();

		Animal b1 = new Bird("Parrot", 2, "Forest", 0.4, true, "Curved");
		b1.display();

		Animal b2 = new Bird("Penguin", 4, "Antarctica", 0.5, false, "Short");
		b2.display();

		Animal f1 = new Fish("Goldfish", 1, "Water", Fish.WaterType.FRESH, 5, "Golden Orange");
		f1.display();
